...
export const renderNavbar = (storeName, tasa, user = null, userRole = '') => {
    ...
    <header class="flex justify-between items-center w-full px-4 py-3 md:px-6 md:py-4 bg-dark-gray border-b border-industrial-gray z-30">
        ...
        <div class="flex items-center gap-2 md:gap-4">
            ...
            <!-- Sync Queue Status -->
            <button id="btn-sync-queue" class="relative flex items-center gap-2 px-2 py-1.5 md:px-3 md:py-2 bg-navy border border-industrial-gray text-slate-400 hover:text-white hover:border-gold transition-all group" style="display: none;">
            ...
            <button id="btn-mobile-cart" class="relative flex items-center justify-center w-8 h-8 md:w-10 md:h-10 bg-navy border border-industrial-gray text-slate-400 hover:text-gold hover:border-gold transition-all lg:hidden rounded-full shadow-lg">
            ...
            ${userDisplay}
            <div class="w-8 h-8 md:w-10 md:h-10 rounded-full bg-navy overflow-hidden border-2 border-gold shadow-lg hidden xs:block">
